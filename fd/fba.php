  		...
  		<div class="container">
	  		<div class="single-col">
		  		<div class="col-md-6">
		  			...
		  			<p>Learn to code your designs using HTML, CSS and Javascript right in your browser. Learning to code in browser saves time and is more graphicly accurate.</p>
		  		</div>
		  		<div class="col-md-6">
