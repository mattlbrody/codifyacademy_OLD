...
<div class="tab-pane" id="tab4">
  <article class="lesson4">
    <div class="lesson_title">
      <h4>Lesson 4</h4>
      <h1>Bootstrap's Tables & Forms</h1>
    </div>
	...
	<div class="task">
		<div class="task1">
			<div class="col-md-8">
				...
				<p class="lead">Lets build on what we built yesterday. Bring this up in sublimetext3</p>
				<ol>
					<li>Lets start by using the whichever container class we didnt use last time, create either a new 
						<code>container</code> or <code>container-fuild</code> div outside our previous <code>container</code> or <code>container-fuild</code> div.
					</li>
					...
					<li>Now we can create our <code>&lt;table class="table"&gt;...&lt;/table&gt;</code> and for kicks lets add all these table classes available with bootstrap 
						<code>table-striped table-bordered table-hover table-condensed</code> to our <code>&lt;table&gt;</code> as classes.
					</li>
					<li>Add our <code>&lt;thead&gt;...&lt;/thead&gt;</code> inside our table, with 1 table row with any contextual color you want 
						<code>&lt;tr class="active"&gt;...&lt;/tr&gt;</code> inside the thead.</li> 
					<li>Add 3 <code>&lt;th&gt;...&lt;/th&gt;</code>elements to go inside our thead. Add the text of Name in the first <code>&lt;th&gt;</code>,
						the text of email in the second <code>&lt;th&gt;</code>,
						and the text of phone number in the third <code>&lt;th&gt;</code>
					</li>
					<li>Create our <code>&lt;tbody&gt;</code> element and inside 3 table rows <code>&lt;tr&gt;...&lt;/tr&gt;</code></li>
					<li>Inside each new tr we'll add 4 table defines <code>&lt;td&gt;...&lt;td&gt;...</code>, and add a few more contextual classes to our new <code>tr</code> and <code>td</code> tags.</li>
					<li>Finally lets fill out our table with some fake information & see how it looks.</li>
				</ol>
				<p>Open this new file in our browser to see how we did!.</p>
				<br>
				<a href="answers/lesson4a.php" target="_blank" class="text-danger">Check out how our new file should look</a>
				...
				<p>Check out <a href="http://getbootstrap.com/css/#tables" target="_blank">Bootstrap Tables</a> to get even more in-depth with Bootstrap Tables!</p>
				<div class="next1">
    ...
    <div id="forms">
    	...
    	<div class="col-md-12">
    		...
    		<p>
				...
				we are simply adding <code>margin-bottom: 15px;</code> to the form elements, giving a nice padding between each tag.
    		</p>
    		<div class="table_example">
	    		<form role="form">
	...
	<div class="task">
		<div class="task1">
			<div class="col-md-8">
				<h3>Now we understand how to style form components...so lets do some coding to remember we learned!</h3>
				<p class="lead">Open our project folder we created earlier</p>
				<ol>
					<li>Lets start by creating a new div with a class of <code>container</code>.</li>
					<li>Again we will add a <code>row</code> inside our <code>contaier</code> div.</li>
					<li>Create a div inside our <code>row</code> with a class of <code>col-xs-12 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4</code> which will limit our form size!</li>
					<li>Now we can add our <code>&lt;form role="form"&gt;...&lt;/form&gt;</code></li>
					<li>Inside lets add 4 <code>div</code> tags with the class of <code>form-group</code> inside our form.</li>
					<li>Inside each  of the first 3 <code>form-group</code>'s create a <code>&lt;label&gt;...&lt;/label&gt;</code>, a <code>&lt;input &gt;</code> and a <code>&lt;p class="help-block"...&lt;/p&gt;</code></li>
					<li>Inside the 4th <code>form-group</code> create a textarea with <code>&lt;textarea rows="5"&gt;...&lt;/textarea&gt;</code></li>
					<li>Next lets add the nice looking bootstrap css to our input's and text area by adding <code>class="form-control"</code> otherwise they wont look pretty!</li>
					<li>Now we need to assign some text to our labels. Set our first label to say: Full Name, our second label should say: Email & the third: Subject</li>
					<li>Add type="text" to the 1st & 3rd <code>input</code> and type="email" in our 2nd <code>input</code></li>
					<li>Finally lets add a little dummy text to our <code>&lt;p&gt;</code> tags with <a href="http://www.lipsum.com" target="_blank">Lurem Ipsum</a> again, add as many word as you'd like into each one!</li>
				</ol>
				<p>Open this new file in our browser, and try resizing the browser. You should notice the form resizing automatically! Woot grid columns for the win!</p>
				<br>
				<a href="answers/lesson4b.php" target="_blank" class="text-danger">Check out how our new file should look</a>
				<p>GREAT JOB!!! you just hand built your first bootstrap form, There're alot of forms out there that need to be designed, now we can do it too!!!</p>
				<p>Check out <a href="http://getbootstrap.com/css/#forms" target="_blank">Bootstrap Forms</a> for even more in-depth talk about FORMS</p>
				<div class="next">
