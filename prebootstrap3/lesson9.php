    ...
    <div class="task">
      <div class="task1">
        <div class="col-md-8">
          ...
          <div class="next1">
            <a href="#tab9" data-toggle="tab" class="btn btn-default btn-lg tabs"><i class="fa fa-child fa-2x"></i>Next section up, Bootstrap Headers, Thumbnails & Jumbotron! <i class="fa fa-2x fa-child"></i></a>
          </div>
        </div>
      </div>
      <br>
