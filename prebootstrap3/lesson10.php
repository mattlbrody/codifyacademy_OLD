<div class="tab-pane" id="tab10">
  <article class="lesson10">
    ...
    <div class="task">
      <div class="task1">
        <div class="col-md-8">
          <h3>Adding Jumbotrons, Page Headers & Thumbnails to any website is a breeze now...so lets write some more of our own <code>CODE</code> to master these!</h3>
          <p class="lead">Open our project folder we have been using the past few days</p>
          <ol>
            <li>Lets Create 3 new divs below everything, give a class of <code>jumbtron</code> to the 1st, a class of <code>clearfix</code> to the 2nd & <code>container</code> to our 3rd new div.</li>
            <li>Inside our jumbotron div, add another div with a class of <code>container</code>. Inside here, add an <code>h1</code> tag with some words, i.e. Awesome Bootstrap Jumbrotron!</li>
            ...
            <li>Set each img src to our 7.11 logo <code>src="img/711.jpg"</code>. <strong>Alternatively</strong> you can set each img <code>src="http://img1.wikia.nocookie.net/__cb20100519113307/mafiawars/images/8/8d/7-eleven_logo-250x250.gif.png"</code>, the images file location, rendering the image without saving it.</li>
            <li>Move into our 3rd original div with the class of <code>container</code>, add 3 new divs inside here, the 1st with a class of <code>jumbotron</code>, the 2nd div give a class of <code>page-header</code> and our 3rd div a class of <code>row</code>.</li>
            <li>In the interior of our container lets again add a <code>h1</code> with some text i.e.: Bootstraps Jumbotron! Add a <code>p</code> below and fill a line of text with <a href="http://www.lipsum.com" target="_blank">Lorem Ipsum</a>, And finally add a <code>a</code> tag with a class of <code>btn btn-success btn-lg</code> and a <code>role="button"</code>. Name the anchor. i.e. Learn More</li>
            <li>In our <code>page=header</code> div add a <code>h1</code>tag and add some text i.e. Example Bootstrap Page Header - Nice!</li>
            <li>Next inside our <code>row</code> div, we need to add four new divs with a class of <code>col-sm-6 col-md-3</code>. Add a new div inside each grid div with a class of <code>thumbnail</code>.</li>
            <li>Add a <code>img</code> & a <code>div</code> with a class of <code>caption</code> in our thumbnail div. Again link our img src to <a href="http://img1.wikia.nocookie.net/__cb20100519113307/mafiawars/images/8/8d/7-eleven_logo-250x250.gif.png" target="_blank">This Sweet 7Eleven Logo</a>.</li>
            <li>We need to add <code>h3</code>, <code>p</code> & 2 <code>a</code>tags inside our caption div. Add the text of "Thumbnail label" to our <code>h3</code>. Fill our <code>p</code> in with some dummy <a href="http://www.lipsum.com" target="_blank">Lorem Ipsum</a> text.</li>
            <li>Add the text of "button" in between both of our open and close <code>a</code> tags, & attach a role of <code>button</code> to each.</li>
            <li>Give the 1st anchor a class of <code>btn btn-success</code> & the 2nd anchor a class of <code>btn btn-danger</code>.</li>
          </ol>
          <p>Open this file in our browser to see our Thumbs, Page-header & JUMBOTRON!</p>
          <br>
          <a href="answers/lesson10.php" target="_blank" class="text-danger">Check out how our new file looked</a>
          <p>Jumbotrons, Thumbnails & Page Headers are great Bootstrap Css elements that we can utilize anytime now!</p>
