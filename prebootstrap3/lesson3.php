...
<div class="tab-pane" id="tab3">
  <article class="lesson3">
    ...
    <div class="lesson_title">
      <h4>Lesson 3</h4>
      <h1>Bootstrap's Helper Classes & Responsive Utilities</h1>
    </div>
...
.center-block {
  ...
  margin-right: auto;
	    ...
	    <div class="col-md-4">
			...
			. Utilizes
			<a href="http://nicolasgallagher.com/micro-clearfix-hack/">the micro clearfix</a>
...
.invisible {
  visibility: hidden;
	...
	<div class="task">
		<div class="task1">
			<div class="col-md-8">
				<h3>Helper classes & Responsive classes can come into handy!</h3>
				...
				<ol>
					...
					<li>In our 2nd column div add the class of <code>bg-danger</code> & <code>hidden-md</code> to our h1, attach a class of <code>text-warning</code> & <code>hidden-md</code> to our h3, and a <code>text-info</code> & <code>hidden-xs</code></li>
				...
				<p>GOOD JOB!!! We now have a firmer grasp on how to use these helper and responsive classes!.</p>
				<p>Check out more <a href="http://getbootstrap.com/css/#helper-classes" target="_blank">Bootstrap Helper classes</a> & 
								  <a href="http://getbootstrap.com/css/#responsive-utilities" target="_blank">Bootstrap Responsive</a> for a look at a few more bootstrap provides.
				</p>
				<div class="next1">
