            ...
            <ul class="course_materials">
              ...
              <li class="">
                <a href="#tab4" data-toggle="tab" class="tabs">
                  ...
                  <h4>Bootstrap's Tables & Forms</h4>
                </a>
              </li>
              ...
              <li class="">
                <a href="#tab5" data-toggle="tab" class="tabs">
                  ...
                  <h4>Bootstrap's Buttons & Images</h4>
                </a>
              </li>
              ...
              <div class="tab-pane active" id="opening_tab">
                ...
                <div class="course_overview col-md-6">
                  <ol class="course_overview_lessons">
                    ...
                    <li><a href="#tab4" data-toggle="tab" title="Bootstrap's Table & Forms" class="tabs">Bootstrap's Table & Forms</a></li>
                    <li><a href="#tab5" data-toggle="tab" title="Bootstrap's Buttons and Images" class="tabs">Bootstrap's Buttons and Images</a></li>
