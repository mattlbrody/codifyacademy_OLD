		...
		<div class="task1">
			<div class="col-md-8">
				...
				<ol>
					...
					<li>Create an <code>h1</code> tag and a <code>p</code> tag in <code>div</code> and using <a href="http://www.lipsum.com/" target="_blank">Lorem Ipsum</a> fill these two tags in</li>
					<li>Let create 3 new divs, all with the following grid classes <code>col-xs-12 col-sm-6 col-md-4</code></li>
