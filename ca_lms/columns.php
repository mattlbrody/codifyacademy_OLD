 	...
 	<body>
	    ...
	    <div class="container-fluid"> 
	    	<div class="course_content">
	    		<h1 class="text-center">Containers & Columns: How Columns work!</h1>
	    ...
	    <div class="container">
	    	<div class="course_content">
	    		<div class="breadcrumbs">
	    			<ol class="breadcrumb">
					  <li><a href="containers.php">How Containers Work</a></li>
					  <li class="active"><a href="columns.php">How Columns Work</a></li>
