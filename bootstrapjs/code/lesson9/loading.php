...
<span class="na">class=</span><span class="s">"btn btn-primary"</span><span class="nt">&gt;</span><span class="content_color">Loading state</span><span class="nt">&lt;/button&gt;</span>
<br>
<br>
<span class="nt">&lt;script&gt;</span>
<br>
<span class="nx form_padding">$</span>
<span class="p">(</span><span class="s1">'#loading-example-btn'</span><span class="p">).</span><span class="nx">click</span><span class="p">(</span><span class="kd">function</span>
<span class="p">()</span>
<span class="p">{</span>
<br>
